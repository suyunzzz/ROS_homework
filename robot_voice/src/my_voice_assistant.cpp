...
#include "/home/s/lession2/src/robot_voice/include/robot_voice/qtts.h"
#include "/home/s/lession2/src/robot_voice/include/robot_voice/msp_cmn.h"
#include "/home/s/lession2/src/robot_voice/include/robot_voice/msp_errors.h"
...
void voiceWordsCallback(const std_msgs::String::ConstPtr& msg)
{
    ...
    if(dataString.compare("forward\u3002") == 0)
    {
        char nameString[40] = "太阳当空照";
        text = nameString;
        std::cout<<text<<std::endl;
    }
    if(dataString.compare("stop\uFF01") == 0)
    {
        char helpString[40] = "花儿对我笑";
        text = helpString;
        std::cout<<text<<std::endl;
    }
   
    if((dataString.compare("stop\uFF01") != 0)&&(dataString.compare("forward\u3002") != 0))
    {
        char helpString[40] = "您说的我没听懂";
        text = helpString;
        std::cout<<text<<std::endl;
    }
